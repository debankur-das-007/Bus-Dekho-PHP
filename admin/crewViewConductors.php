    ...
    <body>
        ...
        <div class="container relative">
            <div style="margin-top: 64px; margin-bottom: 32px;">
                <div class="flex align-center font-28 color-2">Crews >&nbsp;<div class="font-14">View Conductors</div></div>
                <div class="font-14 color-2">Manage your conductors here</div>
            </div>
            <div class="flex flex-column gap-16">
                <?php
                    $query = "SELECT * FROM `conductor_master`";
